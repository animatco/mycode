...
###
### network  --bootproto=static --ip=172.16.11.200 --netmask=255.255.255.0 --gateway=172.16.11.200 --nameserver=8.8.8.8 --hostname centos-linux-8
...
### Sets sha512 to hash passwords. Passwords are shadowed.
